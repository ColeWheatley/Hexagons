...
The generated crop gallery was intentionally not retained in the main checkout;
the measured results and aggregate conclusions are preserved in this report and
`results.json`.
